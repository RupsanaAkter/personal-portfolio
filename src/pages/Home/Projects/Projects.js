...
//   const darkMode = theme.state.darkMode;
    return (
        ...
        >
          <SwiperSlide>
            <h1 className='text-2xl font-bold text-center'>Resturant</h1>
            <img src={resturant} alt="" />
            <h2 className='text-2xl text-bold'>Project Details:</h2>
            <p>
...
<h3 >Technology: HTML, CSS, Javascript</h3>
         ...
         <SwiperSlide>
         <h1 className='text-2xl font-bold text-center'>OpenAI</h1>
            <img src={ai} alt="" />
            <h2 className='text-2xl text-bold'>Project Details:</h2>
            <p>
...
<h3>Technology: HTML, CSS, Javascript</h3>
          ...
          <SwiperSlide>
          <h1 className='text-2xl font-bold text-center'>Hospital</h1>
...
<h3>Technology: HTML, CSS, Javascript</h3>
          ...
          <SwiperSlide>
          <h1 className='text-2xl font-bold text-center'>Hosting-company</h1>
            <img src={hosting} alt="" />
            <h2 className='text-2xl text-bold'>Project Details:</h2>
            <p>
